"friends/ChatRoomDlgFriend.res"
{
	...
	layout
	{
		...
		place { control="GameInviteBar,TradeInviteBar,ChatInfoBar,ChatHistory" y=70 margin-left=6 margin-top=5 margin-right=0 margin-bottom=60 width=max height=max align=right dir=down spacing=5 }
